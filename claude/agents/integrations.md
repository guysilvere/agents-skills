---
name: integrations
description: Argent et intégrations — passerelle GeniusPay (Wave, Orange Money, MTN, Moov, cartes) avec sandbox, webhooks signés + dunning, factures PDF, emails transactionnels Brevo/Mailtrap, stockage Cloudflare R2 (URLs présignées), scripts seed/migration base Turso, workflows n8n liés au SaaS. Invoquer dès qu'une intégration externe, un paiement ou un webhook est en jeu.
